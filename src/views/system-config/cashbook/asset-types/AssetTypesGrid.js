...
export default function AssetTypesGrid() {
    ...
    const assetTypesWithSelect = assetTypes?.map((assetType) => {
        const _selected = selected.includes(assetType.id);
        return {
            ...assetType,
            assetType,
            _selected,
            _classes: [assetType._classes, _selected && 'table-selected'],
        };
    });
