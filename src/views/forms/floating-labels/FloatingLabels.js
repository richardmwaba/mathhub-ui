        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>&lt;CFormLabel&gt;</code> elements in <code>CFormFloating</code>{' '}
                            ...
                            note that the <code>&lt;CFormInput&gt;</code> must come first so we can
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            <code>&lt;CFormLabel&gt;</code>s will automatically adjust to their
                            floated position.
                        </p>
                        <DocsExample href="forms/floating-labels">
                            <CFormFloating>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            By default, <code>&lt;CFormTextarea&gt;</code>s will be the same height
                            as <code>&lt;CFormInput&gt;</code>s.
                        </p>
                        ...
                        <p className="text-medium-emphasis small">
                            To set a custom height on your <code>&lt;CFormTextarea;&gt;</code>, do
                            not use the <code>rows</code> attribute. Instead, set an explicit{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            available on <code>&lt;CFormSelect&gt;</code>s. They work in the same
                            way, but unlike <code>&lt;CFormInput&gt;</code>s, they&#39;ll always
                            show the <code>&lt;CFormLabel&gt;</code> in its floated state.{' '}
                            <strong>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            When working with the CoreUI for Bootstrap grid system, be sure to place
                            form elements within column classes.
                        </p>
