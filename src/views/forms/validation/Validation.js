        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>&lt;CForm&gt;</code>. This disables the browser default feedback
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            with <code>invalid</code> and <code>valid</code> boolean properties.
                        </p>
                        <p className="text-medium-emphasis small">
                            For invalid fields, ensure that the invalid feedback/error message is
                            associated with the relevant form field using{' '}
                            <code>aria-describedby</code> (noting that this attribute allows more
                            than one <code>id</code> to be referenced, in case the field already
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            If your form layout allows it, you can swap the text for the tooltip to
