        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            <code>border-color</code>. You can use any of our text color utilities
                            on the standard spinner.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-medium-emphasis small">
                            Once again, this spinner is built with <code>currentColor</code>, so you
                            can easily change its appearance. Here it is in blue, along with the
                            supported variants.
                        </p>
                        <DocsExample href="components/spinner#growing-spinner">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Add <code>size=&#34;sm&#34;</code> property to make a smaller spinner
