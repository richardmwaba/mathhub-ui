        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            The main block of a card is the <code>&lt;CCardBody&gt;</code>. Use it
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Card titles are managed by <code>&lt;CCardTitle&gt;</code> component.
                            Identically, links are attached and collected next to each other by{' '}
                            <code>&lt;CCardLink&gt;</code> component.
                        </p>
                        <p className="text-medium-emphasis small">
                            Subtitles are managed by <code>&lt;CCardSubtitle&gt;</code> component.
                            If the <code>&lt;CCardTitle&gt;</code> also, the{' '}
                            <code>&lt;CCardSubtitle&gt;</code> items are stored in a{' '}
                            <code>&lt;CCardBody&gt;</code> item, the card title, and subtitle are
                            arranged rightly.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>.card-text</code> can additionally be styled with the regular HTML
                            tags.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Cards assume no specific <code>width</code> to start, so they&#39;ll be
                            100% wide unless otherwise stated. You can adjust this as required with
                            custom CSS, grid classes, grid Sass mixins, or services.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            to change just the <code>border-color</code> of a card. Note that you
                            can set <code>textColor</code> property on the{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            width and height columns. Card groups start off stacked and use{' '}
                            <code>display: flex;</code> to become attached with uniform dimensions
                        ...
                        <p className="text-medium-emphasis small">
                            When using card groups with footers, their content will automatically
                            line up.
                        </p>
                        <DocsExample href="components/card/#card-groups">
                            <CCardGroup>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            property to control how many grid columns (wrapped around your cards)
                            you show per row. For example, here&#39;s{' '}
                            <code>xs=&#123;&#123;cols: 1&#125;&#125;</code> laying out the cards on
                            one column, and <code>md=&#123;&#123;cols: 1&#125;&#125;</code>{' '}
