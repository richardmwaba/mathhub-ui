        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Use <code>striped</code> property to add zebra-striping to any table row
                            within the <code>&lt;CTableBody&gt;</code>.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Use <code>hover</code> property to enable a hover state on table rows
                            within a <code>&lt;CTableBody&gt;</code>.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Add <code>bordered</code> property for borders on all sides of the table
                            and cells.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Add <code>small</code> property to make any <code>&lt;CTable&gt;</code>{' '}
                            more compact by cutting all cell <code>padding</code> in half.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            aligned to the bottom. Table cells in <code>&lt;CTableBody&gt;</code>{' '}
                            inherit their alignment from <code>&lt;CTable&gt;</code> and are aligned
                            to the the top by default. Use the align property to re-align where
                            needed.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>color=&#34;light&#34;</code> or <code>color=&#34;dark&#34;</code>{' '}
                            to make <code>&lt;CTableHead&gt;</code>s appear light or dark gray.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-medium-emphasis small">
                            You can also put the <code>&lt;CTableCaption&gt;</code> on the top of
