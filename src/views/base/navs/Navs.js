        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            The base <code>.nav</code> component is built with flexbox and provide a
                            strong foundation for building all types of navigation components. It
                            includes some style overrides (for working with lists), some link
                            padding for larger hit areas, and basic disabled styling.
                        </p>
                        <DocsExample href="components/navs-tabs#base-nav">
                            <CNav>
                                <CNavItem>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            <code>&lt;nav&gt;</code> element. Because the .nav uses display: flex,
                            the nav links behave the same as nav items would, but without the extra
                            markup.
                        </p>
                        <DocsExample href="components/navs-tabs#base-nav">
                            <CNav component="nav">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <DocsExample href="components/navs-tabs#horizontal-alignment">
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>.flex-column</code> utility. Need to stack them on some viewports
                            but not others? Use the responsive versions (e.g.,{' '}
                            <code>.flex-sm-column</code>).
                        </p>
                        <DocsExample href="components/navs-tabs#vertical">
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>variant=&#34;tabs&#34;</code> class to generate a tabbed interface
                        </p>
                        <DocsExample href="components/navs-tabs#tabs">
                            <CNav variant="tabs">
                                <CNavItem>
                                    <CNavLink href="#" active>
                                        Active
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <DocsExample href="components/navs-tabs#pills">
                            <CNav variant="pills">
                                <CNavItem>
                                    <CNavLink href="#" active>
                                        Active
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            width one of two modifier classes. To proportionately fill all available
                            space with your <code>.nav-item</code>s, use{' '}
                            <code>layout=&#34;fill&#34;</code>. Notice that all horizontal space is
                            occupied, but not every nav item has the same width.
                        </p>
                        <DocsExample href="components/navs-tabs#fill-and-justify">
                        ...
                        <p className="text-medium-emphasis small">
                            For equal-width elements, use <code>layout=&#34;justified&#34;</code>.
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            While more verbose, these utilities offer greater customization across
                            responsive breakpoints. In the example below, our nav will be stacked on
                            the lowest breakpoint, then adapt to a horizontal layout that fills the
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <DocsExample href="components/navs-tabs#tabs-with-dropdowns">
                            <CNav>
                                <CNavItem>
                                    <CNavLink href="#" active>
                                        Active
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <DocsExample href="components/navs-tabs#pills-with-dropdowns">
                            <CNav variant="pills">
                                <CNavItem>
                                    <CNavLink href="#" active>
                                        Active
