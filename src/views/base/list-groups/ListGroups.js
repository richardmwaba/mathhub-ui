                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            states by adding <code>component=&#34;a|button&#34;</code>. We separate
                            these pseudo-classes to ensure list groups made of non-interactive
                            elements (like <code>&lt;li&gt;</code>s or <code>&lt;div&gt;</code>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            <code>&lt;button&gt;</code>s. Note the addition of the hover styles here
                            not present in the previous example. Also supported is the{' '}
                            <code>active</code> state; apply it to indicate an active selection on a
