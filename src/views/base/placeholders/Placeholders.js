        ...
        <CRow>
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Create placeholders with the <code>&lt;CPlaceholder&gt;</code> component
                            and a grid column propx (e.g., <code>xs={6}</code>) to set the{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>currentColor</code>. This can be overridden with a custom color or
                            utility class.
                        </p>
