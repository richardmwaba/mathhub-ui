                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            Progress components are built with two HTML elements, some CSS to set
                            the width, and a few attributes. We don&#39;tuse{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            property to <code>&lt;CProgressBar&gt;</code> to animate the stripes
