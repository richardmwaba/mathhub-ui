                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            as single button dropdowns, but with the addition of boolean prop{' '}
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            that&#39;s attached for normal button dropdowns. Those additional
                            changes hold the caret centered in the split button and implement a more
                            properly sized hit area next to the main button.
                        </p>
