                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            CoreUI includes a bunch of predefined buttons components, each serving
                            its own semantic purpose. Buttons show what action will happen when the
                            user clicks or touches it. CoreUI buttons are used to initialize
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            <code>&lt;a&gt;</code> elements that are used to trigger functionality
                            ex. collapsing content, these links should be given a{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            Disabled button has <code>pointer-events: none</code> applied to,
                            disabling hover and active states from triggering.
                        </p>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            component <code>aria-disabled=&#34;true&#34;</code> attribute to show
                            the state of the component to assistive technologies.
                        </p>
                        <DocsExample href="components/buttons#disabled-state">
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            buttons until the <code>md</code> breakpoint, where{' '}
                            <code>.d-md-block</code> replaces the <code>.d-grid</code> class, thus
                            nullifying the <code>gap-2</code> utility. Resize your browser to see
                            them change.
                        </p>
                        <DocsExample href="components/buttons#block-buttons">
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            <code>.col-6</code>. Center it horizontally with <code>.mx-auto</code>,
                            too.
                        </p>
                        <DocsExample href="components/buttons#block-buttons">
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            horizontal. Here we&#39;ve taken our previous responsive example and
