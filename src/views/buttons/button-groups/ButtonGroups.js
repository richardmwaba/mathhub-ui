        ...
        <CRow>
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p>
                            These classes can also be added to groups of links, as an alternative to
                            the <code>&lt;CNav&gt;</code> components.
                        </p>
                        <DocsExample href="components/button-group">
                            <CButtonGroup>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p>
                            Combine button-like checkbox and radio toggle buttons into a seamless
                            looking button group.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p>
                            ...
                            Similar to the example above, you’ll likely need some utilities through
                            to space items correctly.
                        </p>
                        <DocsExample href="components/button-group#button-toolbar">
                            <CButtonToolbar
                                className="mb-3"
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p>
                            Alternatively, of implementing button sizing classes to each button in a
                            group, set <code>size</code> property to all{' '}
                            <code>&lt;CButtonGroup&gt;</code>&#39;s, including each one when nesting
                            multiple groups.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>&lt;CButtonGroup&gt;</code> when you need dropdown menus combined
