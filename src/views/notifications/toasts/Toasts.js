                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            At a minimum, we require a single element to contain your “toasted”
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            removing the default <code>&lt;CToastHeader&gt;</code>, adding a custom
                            hide icon from <a href="https://coreui.io/icons/">CoreUI Icons</a>, and
                            using some{' '}
                            <a href="https://coreui.io/docs/utilities/flex">flexbox utilities</a> to
                            adjust the layout.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            utilities. Here we&#39;ve set <code>color=&#34;primary&#34;</code> and
                            added <code>.text-white</code> class to the <code>&lt;Ctoast&gt;</code>,
                            and then set <code>white</code> property to our close button. For a
                            crisp edge, we remove the default border with <code>.border-0</code>.
                        </p>
