        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            <code>display</code> have been overridden). Included are the modal
                            header, modal body (required for <code>padding</code>), and modal footer
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            If your modal is too long for user’s viewport, it scrolls the page by
                            itself.
                        </p>
                        ...
                        <p className="text-medium-emphasis small">
                            ...
                            by adding <code>scrollable</code> prop.
                        </p>
                        <DocsExample href="components/modal#scrolling-long-content">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            <code>&lt;CTooltips&gt;</code> and <code>&lt;CPopovers&gt;</code> can be
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            placed on a <code>&lt;CModal&gt;</code>. These sizes kick in at certain
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-medium-emphasis small">
                            ...
                            viewport, available via property <code>fullscreen</code>.
                        </p>
                        <table className="table">
                            <thead>
                                <tr>
